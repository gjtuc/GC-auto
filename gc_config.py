...
핫스pot / 메일:
  ...
  DAILY_SEND_LIMIT=2    — GC2/GC3 오전+오후; GC1 은 gc1_unlimited_auto_send 로 슬롯 생략
...
# GC2/GC3 — --watch 자동 메일: 오전 1회 + 오후 1회 (12:00 기준)
# GC1 — 핫스pot 연결 세션당 1회 (오전/오후 슬롯 한도 없음, 켜진 채로 반복 발송 없음)
DAILY_SEND_LIMIT = 2
...
SMTP_INTERNET_WAIT_MAX_SEC = 90
SMTP_INTERNET_POLL_SEC = 5
SMTP_SEND_RETRIES = 3
SMTP_SEND_RETRY_DELAY_SEC = 12
SMTP_SOCKET_TIMEOUT_SEC = 60
