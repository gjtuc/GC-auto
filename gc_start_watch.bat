...
for %%m in (gc_config gc_console gc_instance gc_profiles gc_gc1 gc_autochro gc_chemstation gc_chem32 gc_kch gc_mailer gc_state gc_wifi gc_wifi_autoconnect gc_status gc_pipeline gc_watch gc_watch_log gc_request gc_error_handler gc_watchdog) do (
