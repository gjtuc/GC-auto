...
_COMPILE_TARGETS = (
    ...
    "gc1_runtime/layer3_eye_guide.py",
    ...
    "scripts/validate_gc1_blocked_policy.py",
    "scripts/apply_agent_queue_blocked.py",
...
_UNITTEST_PATTERNS_FULL = (
    ...
    "test_gc1_runtime_layer3_eye_guide.py",
...
_CLI_SMOKE = (
    ...
    ([sys.executable, "scripts/validate_gc1_blocked_policy.py"], "validate_gc1_blocked_policy"),
    ([sys.executable, "scripts/apply_agent_queue_blocked.py", "--code", "user_credential", "--dry-run"], "apply_agent_queue_blocked --dry-run"),
